    ...
    $.fn.rotatingSlider = function(options){
        var rotatingSlider = {
            init: function(el){
                ...
                this.slideAngle = 180 / this.$slides.length;
                this.currentRotationAngle = -77.1429;
            ...
            renderSlider: function(){
                var halfAngleRadian = this.slideAngle / 3 * Math.PI/180;
                ...
                this.$slidesContainer.css('transform', 'translateX(-50%) rotate(-77.1429deg)');
            ...
            rotate: function(){
                ...
                this.$slidesContainer.css('transition', 'transform '+(this.settings.rotationSpeed/1000)+'s linear');
                this.$slidesContainer.css('transform', 'translateX(-50%) rotate('+this.currentRotationAngle+'deg)');
                ...
                this.rotateTimeoutId = setTimeout(function(){
                    ...
                    if(this.currentRotationAngle >= 0 && this.currentRotationAngle <= 360){
                        this.currentRotationAngle = 0;
                        this.$slidesContainer.css('transform', 'translateX(-50%) rotate('+this.currentRotationAngle+'deg)');
                        selectEDP(0)
                    }
                    else if(this.currentRotationAngle >= -360 && this.currentRotationAngle <= -154.286){
                        this.currentRotationAngle = -154.286;
                        this.$slidesContainer.css('transform', 'translateX(-50%) rotate('+this.currentRotationAngle+'deg)');
                        selectEDP(6)
                    }
                    ...
                    var rotation = $('.rotating-slider .slides').rotationDegrees();   
                        
                    if (rotation <= 360 && rotation >= -13) {
                        selectEDP(0)
                    } else if (rotation <= -14 && rotation >= -40) {
                        selectEDP(1)
                    } else if (rotation <= -41 && rotation >= -65) {
                        selectEDP(2)
                    } else if (rotation <= -66 && rotation >= -90) {
                        selectEDP(3)
                    } else if (rotation <= -91 && rotation >= -116) {
                        selectEDP(4)
                    } else if (rotation <= -117 && rotation >= -142) {
                        selectEDP(5)
                    } else if (rotation <= -143 && rotation >= -360) {
                        selectEDP(6)
                    }
